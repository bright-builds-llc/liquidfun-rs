...
| ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ----------- |
| `standards/languages/typescript-javascript.md` MysticUI+Tailwind default | shadcn-solid (Tailwind CSS v4, Kobalte, and Corvu drawer) for the playground shell | The owner chose the Solid shadcn port so the catalog sidebar slides off-canvas on desktop and opens as a drawer on small screens                                                         | Repository owner | 2026-09-22  |
