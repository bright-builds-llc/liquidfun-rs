...
Plans:
- [ ] 22-01-PLAN.md — Split playground xtask module and mint exclusive evidence stamps
- [ ] 22-02-PLAN.md — Persist unprofiled Dam Break pair.json/pair.md with Rust/C++ ratio
- [ ] 22-03-PLAN.md — Add [profile.profiling] and fail-closed samply argv core
- [ ] 22-04-PLAN.md — Wire dam-break-profile just/xtask capture with fake samply
- [ ] 22-05-PLAN.md — Separate dam-break-timers path with step_profiled parents
...
Plan this phase after Phase 23 names the shares. One concern per wave; re-pair unprofiled into a **new** dated directory; preserve failed records. samply retargets the next wave; Criterion is allowed only if a named kernel remains after the pair is already near 3×. Do not copy the ratio into `manifest.toml`.
...
| 22. Observability shell | v1.2 | 0/6 | Not started | - |
