# Requirements Archive: v1.2 Native Performance Closing

**Archived:** 2026-09-21
**Status:** SHIPPED

All 13 v1.2 requirements were validated and left checked. None were dropped or rewritten. Future requirements PERF-SIMD, PERF-UNSAFE, PERF-PHASE12, and PERF-WASM-ENG stay deferred and were not part of this milestone. The next milestone starts from `/gsd-new-milestone` with a fresh `.planning/REQUIREMENTS.md`.
