...
#[path = "rigid_fixtures/candidate.rs"]
mod candidate;

use std::{fs, path::Path};

use candidate::write_rigid_candidate;
...
use super::{
    domain::{
        ArtifactCandidate, ArtifactKind, CandidateMetadata, FixtureError, MAX_REPORT_BYTES,
        ReplayedCandidate,
    },
    storage::{
        enforce_size, read_manifest, sha256, validate_identifier, validate_preset_profile,
        validate_revision,
    },
};
