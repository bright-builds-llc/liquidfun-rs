//! Evaluation of closed Phase 9 semantic assertions.

use super::{
    PHASE9_REQUIRED_POLICY_PATHS, Phase9EvidenceBindingError, Phase9OccurrenceKind,
    Phase9ParticleBufferMode, Phase9ParticleObservation, Phase9SemanticAssertion,
    Phase9WitnessBinding, RigidBodyKind, RigidWorldObservation, RigidWorldTimeline,
    RigidWorldTimelineResult, ScenarioId,
};

pub(super) fn evaluate_assertion(
...
pub(super) fn expected_action_id(branch: &str) -> &'static str {
    match branch {
...
pub(super) fn unbound_error(message: impl Into<String>) -> Phase9EvidenceBindingError {
    Phase9EvidenceBindingError {
