...
fn check_rejects_unknown_schema_fields() -> TestResult {
    validation_cases::check_rejects_unknown_schema_fields()
}

#[test]
fn check_rejects_duplicate_stable_ids() -> TestResult {
    validation_cases::check_rejects_duplicate_stable_ids()
}

#[test]
fn check_rejects_distinct_ids_for_the_same_upstream_mapping() -> TestResult {
    validation_cases::check_rejects_distinct_ids_for_the_same_upstream_mapping()
}

#[test]
fn check_rejects_unmapped_discovery_entries() -> TestResult {
    validation_cases::check_rejects_unmapped_discovery_entries()
}

#[test]
fn check_rejects_differential_evidence_without_dependencies() -> TestResult {
    validation_cases::check_rejects_differential_evidence_without_dependencies()
}

#[test]
fn check_rejects_omitted_release_identity() -> TestResult {
    validation_cases::check_rejects_omitted_release_identity()
}

#[test]
fn check_rejects_duplicate_release_identity() -> TestResult {
    validation_cases::check_rejects_duplicate_release_identity()
}

#[test]
fn check_rejects_unexplained_release_row() -> TestResult {
    validation_cases::check_rejects_unexplained_release_row()
}

#[test]
fn check_rejects_nonterminal_corpus_item() -> TestResult {
    validation_cases::check_rejects_nonterminal_corpus_item()
}

#[test]
fn check_rejects_mixed_commit_parity_evidence() -> TestResult {
    validation_cases::check_rejects_mixed_commit_parity_evidence()
}

#[test]
fn check_rejects_empty_release_rationale() -> TestResult {
    validation_cases::check_rejects_empty_release_rationale()
}

#[test]
fn check_rejects_coverage_as_parity_authority() -> TestResult {
    validation_cases::check_rejects_coverage_as_parity_authority()
}

#[test]
fn check_rejects_d2_as_parity_authority() -> TestResult {
    validation_cases::check_rejects_d2_as_parity_authority()
}

#[test]
fn discover_and_generate_are_byte_deterministic() -> TestResult {
    validation_cases::discover_and_generate_are_byte_deterministic()
}

#[test]
fn report_check_uses_validated_ledgers_without_native_sources() -> TestResult {
    validation_cases::report_check_uses_validated_ledgers_without_native_sources()
}
...
#[path = "inventory_cli/validation_cases.rs"]
