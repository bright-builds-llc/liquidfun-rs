...
function AccelerometerIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M3.5 4.5C1.5 5.4 1.5 7.3 3.5 8.3 5.5 9.2 5.5 11.1 3.5 12 1.5 12.9 1.5 14.8 3.5 15.8 5.5 16.7 5.5 18.6 3.5 19.5 2.5 20 2 20.7 2 21.4" />
      <rect x="8.5" y="3" width="7" height="18" rx="2" />
      <path d="M10.5 18h3" />
      <path d="M20.5 4.5C22.5 5.4 22.5 7.3 20.5 8.3 18.5 9.2 18.5 11.1 20.5 12 22.5 12.9 22.5 14.8 20.5 15.8 18.5 16.7 18.5 18.6 20.5 19.5 21.5 20 22 20.7 22 21.4" />
    </svg>
  );
}
