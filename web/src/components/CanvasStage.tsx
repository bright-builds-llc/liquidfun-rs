...
function AccelerometerIcon() {
  return (
    <svg viewBox="0 0 31 24" aria-hidden="true">
      <path d="M3.5 1.5C1.5 2.6 1.5 4.7 3.5 5.7 5.5 6.8 5.5 8.9 3.5 9.9 1.5 11 1.5 13.1 3.5 14.1 5.5 15.2 5.5 17.3 3.5 18.3 1.5 19.4 1.5 21.5 3.5 22.5" />
      <rect x="10.5" y="3" width="10" height="18" rx="2" />
      <path d="M13.5 18h4" />
      <path d="M27.5 1.5C29.5 2.6 29.5 4.7 27.5 5.7 25.5 6.8 25.5 8.9 27.5 9.9 29.5 11 29.5 13.1 27.5 14.1 25.5 15.2 25.5 17.3 27.5 18.3 29.5 19.4 29.5 21.5 27.5 22.5" />
    </svg>
  );
}
